...
import { hasStorageAccess, requestStorageAccess, requiresStoragePermissions } from './utils';
...
export default function useStoragePermission() {
  ...
  const [haveCheckedPermission, setHaveCheckedPermission] = React.useState(false);
